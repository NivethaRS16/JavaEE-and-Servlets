...
<body>
	...
	<fmt:setBundle basename="com.test.resources.applicationResources" var="message"/>

	<section id="orders" class="section">
		<div class="container">
			<c:if test="${requestScope.orders!=null}">
				<h2 class="headline">
				<fmt:message bundle="${message}" key="label.home.orders"></fmt:message>	
				</h2>
				<table id="orderHistory">

					<tr>
						<th><fmt:message bundle="${message}" key="label.home.table.header1"></fmt:message></th>
						<th>Product Name</th>
						<th>Order Date</th>
						<th>Product Image</th>
